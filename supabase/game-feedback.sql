...
alter table public.game_reactions add column if not exists reaction_type text not null default 'like';
alter table public.game_reactions drop constraint if exists game_reactions_reaction_type;
alter table public.game_reactions add constraint game_reactions_reaction_type check (reaction_type in ('like', 'dislike'));
